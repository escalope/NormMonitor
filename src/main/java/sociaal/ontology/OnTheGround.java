...
public class OnTheGround extends BasicFact{
	...
	public OnTheGround(String name){
		this.name=name;
	}
	...
	public boolean equals(Object obj) {
		if (obj instanceof OnTheGround){
			return  ((OnTheGround)obj).getName().equals(name);
		}
		return false;
	}
	
	public String toString(){
		return "OnTheGround("+this.getName()+","+this.getTime()+")";
	}
