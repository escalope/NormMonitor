...
public class UnnecesaryActionsPerformed extends PunishmentNorm {

	public UnnecesaryActionsPerformed(String name, String responsible,long time,  KnowledgeHelper kb) {
